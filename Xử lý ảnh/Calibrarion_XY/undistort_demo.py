...
undistort_demo.py
-------------------
Dung ket qua calib (file .npz sinh ra tu calibrate_camera.py) de khu meo
(undistort) mot anh hoac video/webcam.

Vi du:
    # Chay truc tiep (mac dinh): doc file calibration_result.npz va mo webcam 0
    python undistort_demo.py

    # Khu meo 1 anh:
    python undistort_demo.py --calib calibration_result.npz --image test.jpg --out result.jpg

    # Khu meo truc tiep tu webcam:
    python undistort_demo.py --calib calibration_result.npz --camera 0
"""
